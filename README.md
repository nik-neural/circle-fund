...
群組消費記帳 + 圓子基金 — 朋友之間輕鬆分帳。

[![開啟 Web App](https://img.shields.io/badge/開啟-Web_App-10b981?style=for-the-badge)](https://nik-neural.github.io/circle-fund/)
[![License: Non-Commercial](https://img.shields.io/badge/License-Non--Commercial-slate?style=for-the-badge)](./LICENSE)

> **官方 App：** [nik-neural.github.io/circle-fund](https://nik-neural.github.io/circle-fund/)  
> **官方原始碼：** [github.com/nik-neural/circle-fund](https://github.com/nik-neural/circle-fund)

## 功能

- 多人活動記帳，自動計算每人應付 / 應收
- **圓子基金共同錢包（一條全局大數）**，支援墊支同結算轉入
- 雙結餘：帳面（只計開支）同尚收／尚欠（扣已還後）
- 開支「只分 N 人」提示、找部分金額 modal、建議還款「已記 N 筆」
- 建議還款方案 + WhatsApp 分享
- 活動匯出 / 匯入，方便同朋友同步
